...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('app-assets/css-rtl/pages/dashboard-analytics.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('app-assets/css-rtl/pages/card-analytics.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('app-assets/css-rtl/plugins/tour/tour.css')}}">
    <!-- END: Page CSS-->
    ...
    <!-- END: Custom CSS-->
    <link rel="stylesheet" href="{{URL::asset('app-assets/css/custom.css') }}">
    <style>
        .rowdate:hover
        {
