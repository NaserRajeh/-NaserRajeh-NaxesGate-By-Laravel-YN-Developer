            ...
            <div class="col-md-12 ">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" action="{{route('specialization.store')}}" method="POST" >
                                @csrf
                                <div class="card-body">                            
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                        <input type="text"  name="sp_name" value="{{old('sp_name')}}" class="form-control" autocomplete="on">
                                        </div>                            
                                    </div>                            
                                <!-- /.card-body -->
